...
//}
//
//func New(keyStore bccsp.KeyStore) (*fcSigCache, error) {
//	base, err := sw.New(keyStore)
//	if err != nil {
//		return nil, err
//	}
//
//	csp := &fcSigCache{CSP: base}
//
//	// key generators
...
//}
//
//func (csp *fcSigCache) Sign(k bccsp.Key, digest []byte, opts bccsp.SignerOpts) (signature []byte, err error) {
//	// Validate arguments
//	if k == nil {
...
//func (csp *fcSigCache) Verify(k bccsp.Key, signature, digest []byte, opts bccsp.SignerOpts) (valid bool, err error) {
//	// Validate arguments
//	if k == nil {
...
//}
//
//func SignFc(tx *FabricCross, s fcSigCache, k bccsp.Key) (*FabricCross, error) {
...
//}
//
//func FcSender(tx *FabricCross, s fcSigCache,k bccsp.Key) (bool, error) {
